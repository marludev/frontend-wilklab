...
const Privacidad = () => (
  <div className="overflow-x-hidden bg-dark">
    ...
    <div className="container">
      <div className="p-10 my-10 text-gray-100">
        <h5 className="mb-4 text-4xl bold">POLÍTICA DE PRIVACIDAD</h5>
        <p className="text-justify">
          El presente Política de Privacidad establece los términos en que
          Wilklab Agency usa y protege la información que es proporcionada por
        ...
        <h5 className="my-6 text-2xl">Información que es recogida</h5>
        <p className="text-justify">
        ...
        <h5 className="my-6 text-2xl">Uso de la información recogida</h5>
        <p className="text-justify">
          ...
          <br /> <br />
          Wilklab Agency está altamente comprometido para cumplir con el
        ...
        <h5 className="my-6 text-2xl">Cookies</h5>
        ...
        <h5 className="my-6 text-2xl">Enlaces a Terceros</h5>
        ...
        <h5 className="my-6 text-2xl">Control de su información personal</h5>
        <p className="text-justify">
          ...
          <br /> <br />
          Wilklab Agency Se reserva el derecho de cambiar los términos de la
